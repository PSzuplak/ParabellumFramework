...
ParabellumFramework::Graphics::DeviceDirectX12::DeviceDirectX12()
{
	m_device = 0;
	m_commandQueue = 0;
	m_swapChain = 0;
...
ParabellumFramework::Graphics::DeviceDirectX12::DeviceDirectX12(const DeviceDirectX12& ref)
{
...
ParabellumFramework::Graphics::DeviceDirectX12::Initialize(int screenHeight, int screenWidth, void* hwnd, EUINT32 settings)
{
	...
	unsigned int numModes, i, numerator, denominator, stringLength, renderTargetViewDescriptorSize;
	...
	if (FAILED(result))
	{
		MessageBox((HWND)hwnd, L"Could not create a DirectX 12.1 device.  The default video card does not support DirectX 12.1.", L"DirectX Device Failure", MB_OK);
		return PFG_ERROR_CREATEDEVICE;
	}
...
//
ParabellumFramework::EUINT32
ParabellumFramework::Graphics::DeviceDirectX12::Release()
{
	int error;
...
//
ParabellumFramework::EUINT32
ParabellumFramework::Graphics::DeviceDirectX12::Draw()
{
...
//
ParabellumFramework::EUINT32
ParabellumFramework::Graphics::DeviceDirectX12::Update()
{
	return SystemCodes::SUCCESS;
}
...
//	--------------------------------------------------------------------
ParabellumFramework::EUINT32 
ParabellumFramework::Graphics::DeviceDirectX12::RenderBuffers(
	_IN_ VertexBuffer* pVertexBuffer, _IN_ IndexBuffer* pIndexBuffer)
{
	return SystemCodes::SUCCESS;
}
...
ParabellumFramework::Graphics::DeviceDirectX12::CreateShader()
{
	return nullptr;
}
...
ParabellumFramework::EUINT32
ParabellumFramework::Graphics::DeviceDirectX12::ReleaseShader(_IO_ Shader* pShader)
{
	return SystemCodes::SUCCESS;
}
...
ParabellumFramework::Graphics::DeviceDirectX12::CreateRenderTarget(EUINT32 width, EUINT32 height, EUINT32 format, EUINT32 settings)
{
	return nullptr;
}

ParabellumFramework::EUINT32
ParabellumFramework::Graphics::DeviceDirectX12::ReleaseRenderTarget(_IO_ RenderTarget* pRenderTarget)
{
	return SystemCodes::SUCCESS;
}

void
ParabellumFramework::Graphics::DeviceDirectX12::SetDefaultRenderTarget(bool clearDepth)
{

}
void 
ParabellumFramework::Graphics::DeviceDirectX12::SetRenderTargets(
	_IN_ RenderTarget* pRenderTarget, void* pDepthStencilView, bool clearDepth)
{
...
void 
ParabellumFramework::Graphics::DeviceDirectX12::SetRenderTargets(
	_IN_ RenderTarget* pRenderTarget0, _IN_ RenderTarget* pRenderTarget1, void* pDepthStencilView, bool clearDepth)
{
...
void 
ParabellumFramework::Graphics::DeviceDirectX12::SetRenderTargets(
	_IN_ RenderTarget* pRenderTarget0, _IN_ RenderTarget* pRenderTarget1, _IN_ RenderTarget* pRenderTarget2, _IN_ void* pDepthStencilView, bool clearDepth)
{
...
void 
ParabellumFramework::Graphics::DeviceDirectX12::SetRenderTargets(
	_IN_ RenderTarget* pRenderTarget0, _IN_ RenderTarget* pRenderTarget1, _IN_ RenderTarget* pRenderTarget2, _IN_ RenderTarget* pRenderTarget3, void* pDepthStencilView, bool clearDepth)
{
...
void
ParabellumFramework::Graphics::DeviceDirectX12::ClearCurrentRenderTargets(EFLOAT32 r, EFLOAT32 g, EFLOAT32 b, EFLOAT32 a)
{
...
//	--------------------------------------------------------------------
ParabellumFramework::EUINT32
ParabellumFramework::Graphics::DeviceDirectX12::RasterizerSetMode(EUINT32 flag)
{
	return SystemCodes::SUCCESS;
}

ParabellumFramework::EUINT32
ParabellumFramework::Graphics::DeviceDirectX12::RasterizerSetModeWireframe()
{
	return SystemCodes::SUCCESS;
}

ParabellumFramework::EUINT32
ParabellumFramework::Graphics::DeviceDirectX12::RasterizerSetCullNone()
{
	return SystemCodes::SUCCESS;
}

ParabellumFramework::EUINT32
ParabellumFramework::Graphics::DeviceDirectX12::RasterizerSetCullClockwise()
{
	return SystemCodes::SUCCESS;
}

ParabellumFramework::EUINT32
ParabellumFramework::Graphics::DeviceDirectX12::RasterizerSetCullCounterClockwise()
{
	return SystemCodes::SUCCESS;
}
*/