...
//	Filename : Types.h
//
//	Descritpion : Basic data types used in ParabellumUtils. They have fixed bytesize
//
//					
//
//
...
#ifndef __PRAGMAONCE_PARABELLUMUTILS_TYPES_H__
#define __PRAGMAONCE_PARABELLUMUTILS_TYPES_H__
